...
export type Database = {
  // Legacy database shape marker kept for generated table type helpers.
  __InternalServerDatabase: {
...
type DatabaseWithoutInternals = Omit<Database, "__InternalServerDatabase">
