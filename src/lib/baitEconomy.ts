...
export const PREMIUM_SESSIONS_ENABLED = readFlag(import.meta.env.VITE_PREMIUM_SESSIONS_ENABLED, false);
export const COLLECTION_BOOK_ENABLED = readFlag(import.meta.env.VITE_COLLECTION_BOOK_ENABLED, true);
export const WEEKLY_MISSIONS_ENABLED = readFlag(import.meta.env.VITE_WEEKLY_MISSIONS_ENABLED, false);
