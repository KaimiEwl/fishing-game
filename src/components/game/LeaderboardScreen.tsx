    ...
    >
      <div className="grid h-full min-h-0 gap-3 lg:grid-cols-[0.8fr_1.2fr]">
        <aside className="rounded-lg border border-violet-300/20 bg-black/35 p-4 backdrop-blur-md">
          ...
          <div className="mt-4 rounded-lg border border-white/10 bg-white/5 p-3 text-sm text-white/65">
            {isConnected ? (
              <>
        ...
        <section className="rounded-lg border border-white/10 bg-black/35 p-4 backdrop-blur-md">
          <div className="flex h-full min-h-[280px] flex-col items-center justify-center text-center">
            <Trophy className="h-12 w-12 text-violet-200" />
            ...
            <Button
              type="button"
              disabled
              className="mt-5 h-10 rounded-lg bg-white/10 text-white/35"
            >
