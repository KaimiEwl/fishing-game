...
const GameControls: React.FC<GameControlsProps> = ({
  ...
  const primaryStatusBadge = gameState === 'idle'
    ? premiumCastActive
      ...
      : !hasBait
        ...
        : null
    : null;
  const monRewardCard = lastResult?.monReward && lastResult.monReward.amount > 0 ? (
  ...
  const hasRodMonReward = Boolean(lastResult?.monReward && lastResult.monReward.amount > 0);
